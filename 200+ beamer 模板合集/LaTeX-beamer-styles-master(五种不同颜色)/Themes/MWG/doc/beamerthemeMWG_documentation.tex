%%
%%	This is file is the documentation for 'beamerthemeMWG.sty'
%%
%%	The MWG beamer theme is considered as a simple, neutral LaTeX beamer
%%	using the red color of the Markgräfin Wilhelmine Gymnasium in Bayreuth.
%%
...
\begin{document}
	...
	After that, you use the command \mintinline{LaTeX}{\usetheme{MWG}} to set the theme used in your presentation to the MWG theme.

	
	\section{Theme options}
	You can pass some options to the theme which influence how the theme looks. \\
	Syntax: \ \ \mintinline{LaTeX}{\usetheme[options]{MWG}} \\\vspace{0.5ex}
	...
	\begin{center}
		\pgfimage[width=0.4\textwidth,page=1]{steine_MWG} \pgfimage[width=0.4\textwidth,page=2]{steine_MWG} \\
		\pgfimage[width=0.4\textwidth,page=3]{steine_MWG} \pgfimage[width=0.4\textwidth,page=4]{steine_MWG} \\
		\pgfimage[width=0.4\textwidth,page=5]{steine_MWG} \pgfimage[width=0.4\textwidth,page=6]{steine_MWG} \\
		\pgfimage[width=0.4\textwidth,page=7]{steine_MWG} \pgfimage[width=0.4\textwidth,page=8]{steine_MWG}
	\end{center}
